...
var LoaderDefinition = function () {
    ...
    var def = {
        ...
        _updateProgress: function (state) {
          ...
          loaderInfo.dispatchEvent(ProgressEventClass.createInstance([
            'progress',
            false,
            false,
        ...
        _commitSymbol: function (symbol) {
          ...
          case 'font':
            ...
            if (charset) {
              style.insertRule('@font-face{' + 'font-family:"' + symbol.name + '";' + 'src:url(data:font/opentype;base64,' + btoa(symbol.data) + ')' + '}', style.cssRules.length);
